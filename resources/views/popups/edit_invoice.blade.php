                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select id="tarrif-name" name="vessel_id" class="s2 trigger-tarrif-type">

                                </select>
                            </div>
                            <label class="col-sm-8 control-label">Client Name</label>
                            <div class="col-sm-8">
                                <select id="tarrif-name" name="client_id" class="s2 trigger-tarrif-type">

                                </select>
                            </div>

                            <label class="col-sm-8 control-label">Tarrif</label>
                            <div class="col-sm-8">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-success update-tarrif" type="button">Update</button>
                </div>
            </div>
        </div>
    </div>
