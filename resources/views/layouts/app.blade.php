					...
					<div class="row">
						...
						<div class="col-xs-6 col-sm-8 top-panel-right">
							<ul class="nav navbar-nav pull-right panel-menu">
								...
								@else
								<li class="hidden-xs">
									<a href="{{route('getUnapprovedInvoices')}}" class="modal-link">
										<i class="fa fa-bell"></i>
										<span class="badge">{{$unapprovedInvoices}}</span>
									</a>
								</li>
								<li class="dropdown">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="{{route('getTarrifForm')}}">&nbsp;&nbsp;&nbsp;
											<i class="fa fa-database">&nbsp;</i>Tarrif </a>
									</li>
									<li>
										<a href="{{route('getTarrifTypeForm')}}">&nbsp;&nbsp;&nbsp;
											<i class="fa fa-database">&nbsp;</i>Tarrif Type</a>
									</li>
									<li>
										<a href="{{route('getTarrifParamForm')}}">&nbsp;&nbsp;&nbsp;
											<i class="fa fa-database">&nbsp;</i>Tarrif Parameters</a>
									</li>
									<li>
										<a href="{{route('getTarrifChargeForm')}}">&nbsp;&nbsp;&nbsp;
											<i class="fa fa-database">&nbsp;</i>Tarrif Charges</a>
									</li>
								</ul>
							</li>
						</ul>
						...
						<ul class="dropdown-menu">
							<li>
								<a href="{{route('invoice')}}">
									<i class="fa fa-shopping-cart">&nbsp;</i>Prepare Invoice</a>
							</li>
							<li>
								<a href="{{route('invoiceInfoPage')}}">
									<i class="fa fa-history">&nbsp;</i>Invoice History</a>
							</li>
							<li>
								<a href="{{route('getTrackPayments')}}">
									<i class="fa fa-credit-card">&nbsp;</i>Track Payments</a>
							</li>
						</ul>
					</li>
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="{{route('cashPayments')}}">
									<i class="fa fa-certificate">&nbsp;</i>Cash Payments</a>
							</li>
							<li>
