...
class VesselController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            Audit::create(['user' => Auth::user()->username, 'activity' => 'Updated Vessel ' . $request->vessel_name, 'act_date' => date('Y-m-d'), 'act_time' => time('H:i:s')]);
    ...
    {
        if ($request->ajax()) {
            Audit::create(['user' => Auth::user()->username, 'activity' => 'Update vessel operator ' . $request->operator_name, 'act_date' => date('Y-m-d'), 'act_time' => time('H:i:s')]);
    ...
    {
        if ($request->ajax()) {
            Audit::create(['user' => Auth::user()->username, 'activity' => 'Deleted Vessel ' . $request->vessel_name, 'act_date' => date('Y-m-d'), 'act_time' => time('H:i:s')]);
