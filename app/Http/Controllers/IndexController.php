...
class IndexController extends Controller
{
    ...
    public function postUser(Request $request)
    {
        ...
        Audit::create(['user' => Auth::user()->username, 'activity' => 'Created user with username' . $request->username, 'act_date' => date('Y-m-d'), 'act_time' => time('H:i:s')]);
    ...
    {
        if ($request->ajax()) {
             Audit::create(['user' => Auth::user()->username, 'activity' => 'Updated user with username' . $request->username, 'act_date' => date('Y-m-d'), 'act_time' => time('H:i:s')]);
